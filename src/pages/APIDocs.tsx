    ...
    <div className="flex-1 p-6 lg:p-12 max-w-5xl mx-auto space-y-12">
      <div className="space-y-2">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-4xl font-black text-gray-900">REST API Documentation</h1>
        </div>
        <p className="text-gray-500 text-lg">Automatically generated endpoints for your custom data models.</p>
      </div>
      ...
      <div className="space-y-16">
          ...
          return (
            <section key={model.id} className="space-y-6">
              <div className="border-b border-gray-200 pb-4">
                <h2 className="text-2xl font-bold text-gray-900">{model.name} API</h2>
                <p className="text-sm font-mono text-gray-400">Base Path: /api/{model.collectionName}</p>
              </div>
                  ...
                  <div key={i} className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
                    <div className="p-4 bg-gray-50 border-b border-gray-200 flex justify-between items-center">
                      <div className="flex items-center gap-3">
                        ...
                        <code className="text-sm font-bold text-gray-700">{ep.path || '/'}</code>
                      </div>
                    ...
                    <div className="p-4 space-y-4">
                      ...
                      {ep.body && (
                        <div className="space-y-2">
                          <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Sample Payload</p>
                          <pre className="bg-gray-50 text-gray-600 p-4 rounded-xl text-xs border border-gray-100">
        ...
        {models.length === 0 && (
          <div className="py-20 text-center bg-gray-50 rounded-3xl border-2 border-dashed border-gray-200">
            <p className="text-gray-400 italic">No custom data models defined yet. API documentation will appear here once you create a model.</p>
          </div>
        )}
      </div>
    </div>
